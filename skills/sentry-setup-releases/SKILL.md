...
description: Configure or diagnose Sentry release tags, CI deploy tracking, and suspect-commit association.
license: Apache-2.0
---

# Sentry releases

Start with [release diagnosis](references/releases/index.md). Determine whether
...
choice is unresolved. Use the [SDK index](references/sdks/index.md) for the
relevant build-tool integration.

Read only the branch that needs work:

- Event version or environment: [tagging](references/releases/tagging.md).
- Release creation and deploy records: [CI pipeline](references/releases/ci-pipeline.md).
- Commit association: [suspect commits](references/releases/suspect-commits.md).
- Existing wiring that produces incomplete results:
  [troubleshooting](references/releases/troubleshooting.md).
