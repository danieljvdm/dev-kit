...
Monitoring + Sentry Logging [+ Metrics/Crons if applicable]. Shall I proceed?”_

**No OTel:** _“I recommend Error Monitoring + Tracing + Logging
[+ Metrics if applicable]. Shall I proceed?”_
...
| Logging          | `./logging.md`          | Structured log capture                                   |
| Metrics          | `./metrics.md`          | Sidekiq present; existing metric patterns                |
| Profiling        | `./profiling.md`        | Performance profiling requested (beta)                   |
| Crons            | `./crons.md`            | Scheduled jobs detected or requested                     |
