...
- ⚠️ **Profiling** — removed in sentry-go v0.31.0; see `./profiling.md` for alternatives
...
Propose: _“I recommend setting up Error Monitoring + Tracing [+ Logging if applicable].
Want me to also add Metrics or Crons?”_
...
| Logging          | `./logging.md`          | logrus / zap / zerolog / slog detected                                                                        |
| Metrics          | `./metrics.md`          | Business KPIs / SLO tracking                                                                                  |
| Crons            | `./crons.md`            | Scheduler / cron job patterns detected                                                                        |
