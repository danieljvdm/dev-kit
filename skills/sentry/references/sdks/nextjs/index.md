...
Propose: _“I recommend setting up Error Monitoring + Tracing + Session Replay.
Want me to also add Logging or Profiling?”_
...
`SENTRY_AUTH_TOKEN` is a build-time secret, distinct from the DSN.
...
| Profiling        | `./profiling.md`        | Continuous profiling, `Document-Policy` header, `nodeProfilingIntegration`                         |
