...
| [`suspect-commits.md`](suspect-commits.md) | The SCM integration, code mappings, resolve-by-commit, and auto-assignment — plus why suspect commits mostly do _not_ run on release commits.                 |
