---
name: tdd
description: Use test-first development when the user explicitly requests TDD or a red-green workflow.
license: MIT
---
...
[test design](references/test-design.md). Avoid a new abstraction solely to
...
Dev Kit maintains this fork of Matt Pocock's skill. See [NOTICE](NOTICE) and
[LICENSE](LICENSE).
